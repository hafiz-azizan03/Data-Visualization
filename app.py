    ...
    try:
        ...
        try:
            ...
            fig1.update_layout(
                ...
                yaxis_title='Value',
                template='plotly'  # Use a light theme for aesthetics
            )
...
@app.route('/dashboard')
def dashboard():
    chart_path1 = request.args.get('chart_path1', '')
    chart_path2 = request.args.get('chart_path2', '')
    chart_path3 = request.args.get('chart_path3', '')
    chart_path4 = request.args.get('chart_path4', '')
